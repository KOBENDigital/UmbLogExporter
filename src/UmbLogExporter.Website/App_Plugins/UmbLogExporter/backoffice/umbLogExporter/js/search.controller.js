(function () {
	...
	function logViewerSearchController($location, logViewerResource, overlayService, umbLogExporterResource) {
		...
		//custom
		vm.searchButtonGroup = {
			defaultButton: {
				labelKey: "general_search",
				hotKey: "",
		...
		function exportLog() {
			umbLogExporterResource.exportLogs(vm, vm.logOptions);
		}
